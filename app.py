...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:lz-prod-sqlserver.database.windows.net,1433;Database=lz-prod-db1;Uid=sqladmin;Pwd=Mysql@123;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
